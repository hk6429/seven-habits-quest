...
export const PASS_STARS = 2; // 單一小關幾顆星算過關
// 一大關 15 小關、每關最多 3★（滿 45★）。要湊滿這個星數才算斬掉古神、解鎖下一層。
// 43 = 只能有 2 關低空 ★★ 過，其餘 13 關都要 ★★★ —— 防亂按、逼真正讀題。
export const HABIT_STAR_GATE = 43;
// 同一關內點到「陷阱選項」(q=0) 達這個次數，當場判失敗，不讓你拖到結算。
export const TRAP_FAIL_LIMIT = 2;
